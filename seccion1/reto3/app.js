...
console.log(`El producto mas barato que se puede llevar es ${candidatosParaLLevar[0].nombreArticulo} con su respectivo precio de ${candidatosParaLLevar[articulo].precioArticulo}` );
